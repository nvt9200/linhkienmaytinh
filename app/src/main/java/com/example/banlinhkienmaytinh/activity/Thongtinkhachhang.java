        ...
        btnxacnhan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ten.length()>0 && sdt.length() > 0 && email.length() > 0) {
                                ...
                                StringRequest request = new StringRequest(Request.Method.POST, Server.Duongdanchitietdonhang, new Response.Listener<String>() {
                                    ...
                                    public void onResponse(String response) {
                                        if (response.equals("1")){
                                            ...
                                            CheckConnection.ShowToat_Short(getApplicationContext(),"Bạn đã thêm dữ liệu giỏ hàng thành công");
                                            Intent intent = new Intent(getApplicationContext(),MainActivity.class);
                                            startActivity(intent);
                                            CheckConnection.ShowToat_Short(getApplicationContext(),"Mời bạn tiếp tục mua hàng");
                                        }else {
                                            CheckConnection.ShowToat_Short(getApplicationContext(),"Dữ liệu giỏ hàng bạn đã bị lỗi");
                                        }
                                    }
                    ...
                    Toast.makeText(Thongtinkhachhang.this, "Hãy kiểm tra dữ liệu", Toast.LENGTH_SHORT).show();
                }
            }
        });
        btntrove.setOnClickListener(new View.OnClickListener() {
