...
import com.example.banlinhkienmaytinh.adapter.GiohangAdapter;
...
public class Giohang extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_giohang2);
        Anhxa();
        AcctionToolbar();
        CheckData();
        EvenUltil();
        ...
        btnthanhtoan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (MainActivity.manggiohang.size() > 0) {
                    ...
                    CheckConnection.ShowToat_Short(getApplicationContext(),"Giỏ hàng của bạn chưa có sản phẩm để thanh toán");
                }
            }
        });
    }
