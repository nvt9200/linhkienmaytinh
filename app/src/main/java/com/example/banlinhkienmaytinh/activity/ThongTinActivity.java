...
public class ThongTinActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng nhatro = new LatLng(10.978692, 106.674338);
        mMap.addMarker(new MarkerOptions().position(nhatro).title("Shop Linh kiện máy tính").snippet("113/37/81 Khu phố 6, phường Phú Hòa, thành phố Thủ Dầu Một, Bình Dương").icon(BitmapDescriptorFactory.defaultMarker()));
        mMap.setMapType(GoogleMap.MAP_TYPE_NORMAL);
        CameraPosition cameraPosition = new CameraPosition.Builder().target(nhatro).zoom(90).build();
